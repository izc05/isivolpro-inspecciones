...
export const checklistPublicaConcurrencia = [
  {
    ...
    "help": {
      ...
      "whatToCheck": [
        ...
        "Tipo de local y uso",
        "Aforo previsto",
        "Servicios de seguridad aplicables"
      ],
      "criteria": [
        "Tipo de local indicado",
        "Uso identificado",
        "Aforo indicado si procede"
      ],
      "defects": [
        "No consta clasificación",
        "No consta aforo",
        "Servicios de seguridad no definidos"
      ],
      "images": [
        "Extracto de proyecto con clasificación y aforo"
      ]
    },
    "itc": "ITC-BT-28",
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        "Aforo documentado",
        "Uso coherente con la inspección"
      ],
      "defects": [
        "No consta aforo",
        "Aforo incoherente con uso o superficie"
      ],
      "images": [
        "Extracto de proyecto con clasificación y aforo"
      ]
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        "Proyecto disponible cuando proceda",
        "Documentación coherente con la instalación"
      ],
      "defects": [
        "No se aporta proyecto",
        "Proyecto incompleto o no actualizado"
      ],
      "images": [
        "Extracto de proyecto con clasificación y aforo"
      ]
    ...
    "fuente": "REBT 2002 (RD 842/2002), ITC-BT-04 / ITC-BT-28. Resumen técnico propio para inspección.",
  ...
  },
  {
    ...
    "question": "¿El esquema unifilar coincide con la instalación real inspecciónada?",
    "reference": "REBT 2002 / ITC-BT-04 / ITC-BT-28",
    "favorable": "Debe coincidir con la instalación real inspecciónada.",
    "favorableCriteria": "Debe coincidir con la instalación real inspecciónada.",
    "severity": "DL",
    "defaultSeverity": "DL",
    "requiresPhotoIfDefect": true,
    "requiresMeasurement": false,
    ...
    "help": {
      ...
      "criteria": [
        "Esquema actualizado",
        "Coincidencia con la instalación real"
      ],
      "defects": [
        "Esquema inexistente",
        "Esquema desactualizado",
        "Circuitos no coincidentes"
      ],
      "images": [
        "/help/04_01_15_distribucion_alumbrado_tercios.png"
      ]
    },
    "itc": "ITC-BT-04 / ITC-BT-28",
    "apartado": "Apartado aplicable según la ITC indicada",
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        ...
        "Mantenimiento o pruebas documentadas"
      ],
      "defects": [
        "Sin documentación de emergencias",
  ...
  },
  {
    ...
    "help": {
      ...
      "whatToCheck": [
        "Uso",
        "Aforo",
        "Actividad recreativa o espectaculo",
        "Uso sanitario",
        "Trabajo/reunion > 300 personas"
      ],
      "criteria": [
        "Necesidad justificada",
        "Tipo de suministro definido"
      ],
      "defects": [
        "No se justifica necesidad",
        "No se identifica tipo requerido"
      ],
      "images": [
        "/help/04_01_18_suministro_complementario.png"
      ]
    },
    "itc": "ITC-BT-28",
    "apartado": "Apartado aplicable según la ITC indicada",
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        "Socorro operativo",
        "Servicios reglamentarios alimentados"
      ],
      "defects": [
        "No existe si aplica",
        "Servicios no alimentados",
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        "Reserva instalada donde procede",
        "Servicios críticos alimentados"
      ],
      "defects": [
        "No existe reserva cuando aplica",
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        ...
        "Automática si procede",
        "Sin acoplamientos indebidos"
      ],
      "defects": [
        "No conmuta",
        "Conmutación manual no justificada",
        "Riesgo de retorno a red"
      ],
      "images": [
        "/help/04_01_18_suministro_complementario.png"
      ]
  ...
  },
  {
    ...
    "help": {
      ...
      "defects": [
        "Servicio esencial sin alimentar",
        "Circuito no identificado",
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        "Emergencias instaladas",
        "Cobertura razonable del local"
      ],
      "defects": [
  ...
  },
  {
    ...
    "question": "¿La autonoma mínima del alumbrado de emergencia es de al menos 1 hora?",
    "reference": "REBT 2002 / ITC-BT-28",
  ...
  },
  {
    ...
    "fields": [
      {
        "key": "luxEvacuation",
        "label": "Lux evacuación",
        "unit": "lx"
      }
    ],
    "helpVisual": "Medición 1 lux en rutas de evacuación",
    "help": {
      ...
      "criteria": [
        ">= 1 lux en eje de rutas de evacuación"
      ],
      "defects": [
        "Lux insuficiente",
        "Ruta sin luminaria",
  ...
  },
  {
    ...
    "fields": [
      {
        "key": "luxSafetyEquipment",
        "label": "Lux cuadros/PCI",
        "unit": "lx"
      }
    ],
    "helpVisual": "Medición 5 lux en cuadros y PCI",
    "help": {
      ...
      "whatToCheck": [
        ...
        "Extintores",
        "BIE",
        "Pulsadores o equipos manuales"
      ],
      "criteria": [
        ">= 5 lux en equipos de uso manual y cuadros"
      ],
      "defects": [
        "Lux insuficiente",
        "Equipo sin iluminación",
  ...
  },
  {
    ...
    "question": "¿El alumbrado antipánico permite identificar y acceder a rutas de evacuacin?",
    "reference": "REBT 2002 / ITC-BT-28",
    ...
    "help": {
      ...
      "criteria": [
        "Permite orientarse",
        "Permite acceder a evacuación"
      ],
      "defects": [
        "Zonas abiertas sin cobertura",
        "Lux insuficiente",
        "Equipos averiados"
      ],
      "images": [
  ...
  },
  {
    ...
    "help": {
      ...
      "defects": [
        "Falta luminaria en punto crtico",
  ...
  },
  {
    ...
    "question": "¿Existe iluminacin suficiente junto a cuadros de distribucin?",
    "reference": "REBT 2002 / ITC-BT-28",
    ...
    "help": {
      ...
      "criteria": [
        "Iluminación suficiente junto a cuadros"
      ],
      "defects": [
        "Cuadro sin emergencia próxima",
        "Lux insuficiente"
      ],
      "images": [
        "/help/04_01_21_cuadros_no_accesibles_publico.png"
      ]
    },
    "itc": "ITC-BT-28",
    "apartado": "Apartado aplicable según la ITC indicada",
  ...
  },
  {
    ...
    "question": "¿Las salidas y seales de seguridad reglamentarias están iluminadas?",
    "reference": "REBT 2002 / ITC-BT-28",
    ...
    "requiresPhotoIfDefect": true,
    "requiresMeasurement": false,
    "helpVisual": "Señalización de salidas iluminada",
    "help": {
      ...
      "defects": [
        "Señal sin iluminación",
        "Salida no señalizada",
        "Señal no visible"
      ],
      "images": [
        "/help/04_01_07_ubicación_luminarias_emergencia.png"
  ...
  },
  {
    ...
    "question": "¿Las luminarias están sin roturas, bateras agotadas o pilotos de fallo?",
    "reference": "REBT 2002 / ITC-BT-28",
  ...
  },
  {
    ...
    "question": "¿Los cuadros están en zonas no accesibles al pblico o protegidos?",
    "reference": "REBT 2002 / ITC-BT-28",
  ...
  },
  {
    ...
    "fuente": "REBT 2002 (RD 842/2002), ITC-BT-28 / ITC-BT-24. Resumen técnico propio para inspección.",
    "tipoCriterio": "normativo",
    "evidenciasRequeridas": [
      "Fotografía del punto si existe defecto"
    ],
  ...
  },
  {
    ...
    "question": "¿El corte de una lnea no afecta a ms de un tercio del alumbrado del local o zona?",
    "reference": "REBT 2002 / ITC-BT-28",
    ...
    "help": {
      ...
      "criteria": [
        "Una línea no afecta a más de 1/3 del alumbrado"
      ],
      "defects": [
        "Una línea apaga demasiadas luminarias",
        "Reparto deficiente"
      ],
      "images": [
        "/help/04_01_15_distribucion_alumbrado_tercios.png"
  ...
  },
  {
    ...
    "fuente": "REBT 2002 (RD 842/2002), ITC-BT-22 / ITC-BT-24 / ITC-BT-28. Resumen técnico propio para inspección.",
    "tipoCriterio": "normativo",
    "evidenciasRequeridas": [
      "Fotografía del punto si existe defecto"
    ],
  ...
  },
  {
    ...
    "help": {
      ...
      "defects": [
        "Servicios críticos en circuito no selectivo",
        "Protección común inadecuada"
      ],
      "images": [
        "/help/04_01_18_suministro_complementario.png"
      ]
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        "Cable AS donde procede",
        "Marcado identificable"
      ],
      "defects": [
        "Cable no AS",
        "Marcado no visible",
        "No se justifica cable"
      ],
      "images": [
        "/help/04_01_17_cables_as_asplus.png"
      ]
    },
    "itc": "ITC-BT-28",
    "apartado": "Apartado aplicable según la ITC indicada",
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        "Cable resistente al fuego si aplica",
        "Servicio crtico identificado"
      ],
      "defects": [
        "Servicio crtico sin cable adecuado",
        "Marcado no justificado"
      ],
      "images": [
        "/help/04_01_17_cables_as_asplus.png"
      ]
  ...
  },
  {
    ...
    "fuente": "REBT 2002 (RD 842/2002), ITC-BT-28 / ITC-BT-20. Resumen técnico propio para inspección.",
    "tipoCriterio": "normativo",
    "evidenciasRequeridas": [
      "Fotografía del punto si existe defecto"
    ],
  ...
  },
  {
    ...
    "question": "¿No existen cables accesibles, sueltos o sin protección al pblico?",
    "reference": "REBT 2002 / ITC-BT-28 / ITC-BT-24",
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        "Empalmes en caja cerrada",
        "Bornes adecuados"
      ],
      "defects": [
        "Empalme fuera de caja",
        "Caja sin tapa",
        "Borne inadecuado"
      ],
      "images": [
    ...
    "fuente": "REBT 2002 (RD 842/2002), ITC-BT-28 / ITC-BT-19. Resumen técnico propio para inspección.",
    "tipoCriterio": "normativo",
    "evidenciasRequeridas": [
      "Fotografía del punto si existe defecto"
    ],
  ...
  },
  {
    ...
    "question": "¿Existe separación o protección frente a agua, gas, climatizacin u otros servicios?",
    "reference": "REBT 2002 / ITC-BT-28 / ITC-BT-20",
    ...
    "help": {
      ...
      "criteria": [
        ...
        "Protección cuando proceda"
      ],
      "defects": [
        "Canalización bajo tubería con condensación",
        "Sin separación",
        "Riesgo mecánico"
      ],
      "images": [
  ...
  },
  {
    ...
    "question": "¿Las escaleras o desniveles con riesgo de caída están sealizados o iluminados?",
    "reference": "REBT 2002 / ITC-BT-28",
    ...
    "help": {
      ...
      "criteria": [
        "Escaleras iluminadas o balizadas",
        "Recorrido visible"
      ],
      "defects": [
        "Escalera sin emergencia",
  ...
  },
  {
    ...
    "question": "¿Las rampas con inclinacin significativa cuentan con alumbrado o señalización adecuada?",
    "reference": "REBT 2002 / ITC-BT-28",
    ...
    "help": {
      ...
      "criteria": [
        "Rampa iluminada o señalizada",
        "Sin zonas oscuras"
      ],
      "defects": [
        "Rampa sin iluminación",
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        ">= 15 lux o >= 10 % de iluminación normal"
      ],
      "defects": [
        "Zona sin alumbrado específico",
        "Lux insuficiente",
        "Equipo averiado"
      ],
      "images": [
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        "Reemplazo donde procede",
        "Servicios esenciales alimentados"
      ],
      "defects": [
        "Sin reemplazo donde aplica",
  ...
  },
  {
    ...
    "help": {
      ...
      "criteria": [
        "Bloques relacionados activados",
        "Riesgos específicos revisados"
      ],
      "defects": [
        "Bloque especial no activado",
        "Zona especial no evaluada"
      ],
      "images": [
        "/help/04_01_15_distribucion_alumbrado_tercios.png"
      ]
...
export default checklistPublicaConcurrencia;
